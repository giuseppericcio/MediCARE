...
if selected_patient is None:
    ...
    with placeholder2.expander("⚠️ Before using the framework, it is important to read the disclaimer: Read"):
        disclaimer = f"""
...
with l1:
    ...
    if task == "medications":
        ...
        st.subheader("Predicted _diagnosis_ ")
...
st.caption("The following section is dedicated to the CORE AI component, which is responsible for generating the analysis of the doctors' proposals and the collaborative discussion between the medical team members for the final decision on the patient's treatment.")
